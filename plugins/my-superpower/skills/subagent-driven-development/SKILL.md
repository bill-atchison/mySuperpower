...
run `scripts/task-brief-html --plan PLAN_FILE` and read the file it writes. If the plan names a Spec, read that too: the spec is the
...
- **Task brief:** before dispatching an implementer, run this skill's
  `scripts/task-brief PLAN_FILE N` — or `scripts/task-brief-html PLAN_FILE N`
...
[Read plan body once: scripts/task-brief-html --plan docs/mySuperpower/plans/feature-plan.html]
[Resolve workspace: scripts/sdd-workspace docs/mySuperpower/plans/feature-plan.html — no ledger inside, fresh start]
