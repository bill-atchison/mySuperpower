...
6. **Write design doc** — save to `docs/mySuperpower/specs/YYYY-MM-DD-<topic>-design.html` and commit
...
- Write the validated design (spec) to `docs/mySuperpower/specs/YYYY-MM-DD-<topic>-design.html`
