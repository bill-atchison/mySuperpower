...
- Save to `docs/mySuperpower/plans/YYYY-MM-DD-<feature-name>.html`.
- Keep the plan's task/step structure (goal, architecture, tasks, bite-sized steps) inside the HTML body.

Before handing off to execution, open the `.html` in the user's browser for an acceptance gate and get sign-off.
